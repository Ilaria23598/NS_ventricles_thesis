...
def problemsolver(filename, iteration = 0, conv = False, errors = False):
	...
	# Temporal advancement
		...
		# Dirichlet Boundary Conditions vector construction
		        ...
		        a, L = VariationalFormulationUnsteadyNAVIERSTOKES(param, u, v,p,q, dt, n, u_old,p_old, K, t, mesh, ds_vent, ds_skull)
...
def VariationalFormulationMixSteadyNAVIERSTOKES(param, u, v, p,q, dt, n, u_n,p_n, K, time, mesh, ds_vent, ds_skull):
...
def VariationalFormulationMixUnsteadySTOKES(param, u, v, p, q, dt, n, u_old, p_old, K, time, mesh, ds_vent, ds_skull):
...
def VariationalFormulationUnsteadyNAVIERSTOKES(param, u, v, p, q, dt, n, u_old,p_old, K, time, mesh, ds_vent, ds_skull):
