...
def Navier_Stokes_Errors(param, x, errors, mesh, iteration, T, n):
	...
	errorsnew = pd.DataFrame({'Error_L2_u': Error_L2_u,'Error_DG_u': ErrDGu, 'Error_H1' : Error_H1_u,'Error_L2_p': Error_L2_p,'Error_DG_p': ErrDGp}, index=[iteration])
	#errorsnew = pd.DataFrame({'Error_L2_u': Error_L2_u, 'Error_H1' : Error_H1_u,'Error_L2_p': Error_L2_p,'Error_DG_p': ErrDGp}, index=[iteration])
